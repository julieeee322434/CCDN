        ...
        <table class="table">
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <td>$row[grave_id]</td>
                    <td>
                        <a class='btn btn-primary btn-sn' href='/St. John/edit.php'>Edit</a>
                        <a class='btn btn-danger btn-sn' href='/St. John/delete.php'>Delete</a>
                    </td>
                </tr>
                ";
            }
